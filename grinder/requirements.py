...
NUM_INSTANCES = NovaClientCapability('num-instances')
LAUNCH_KEY = NovaClientCapability('launch-key')
SCHEDULER_HINTS = NovaClientCapability('scheduler-hints')
INSTALL_POLICY = NovaClientCapability('install-policy')
